...
public class QuestionEighteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_eighteen);
    ...
    private void sendScreenName() {
        String name = getResources().getString(R.string.q18);
    ...
    public void onClick(View v) {
        ...
        //changes screen
        Intent intent = new Intent(this, QuestionNineteen.class);
