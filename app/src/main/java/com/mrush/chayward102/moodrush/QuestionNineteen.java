...
public class QuestionNineteen extends AppCompatActivity {
    ...
    private void sendScreenName() {
        String name = getResources().getString(R.string.q19);
    ...
    public void onClick(View v) {
        ...
        mTracker.send(new HitBuilders.EventBuilder()
                .setCategory(getResources().getString(R.string.q19))
        ...
        //changes screen
        Intent intent = new Intent(this, QuestionTwenty.class);
