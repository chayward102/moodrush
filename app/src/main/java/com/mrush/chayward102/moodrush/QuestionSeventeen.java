...
public class QuestionSeventeen extends AppCompatActivity {
    ...
    private void sendScreenName() {
        String name = getResources().getString(R.string.q17);
    ...
    public void onClick(View v) {
        ...
        mTracker.send(new HitBuilders.EventBuilder()
                .setCategory(getResources().getString(R.string.q17))
        ...
        //changes screen
        Intent intent = new Intent(this, QuestionEighteen.class);
